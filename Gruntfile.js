                ...
                files: [
                    {
                        ...
                        src: [
                            '*.{ico,png,txt}',
//                      'bower_components/**/*',
                            'bower_components/ng-ckeditor/libs/ckeditor/*.js',
                            'bower_components/ng-ckeditor/libs/ckeditor/*.css',
                            ...
                            'bower_components/one-app-core/modules/**/*.html',
                            'bower_components/one-app-core/scripts/**/*.html',
                            'bower_components/one-app-core/themes/ace/assets/font/**',
                            'images/{,*/}*.{webp}',
                            'fonts/*'
                        ]
                    },
